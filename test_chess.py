...
TEST_ROOKS = True
TEST_BISHOPS = True
TEST_BOARD_SETUP = True
TEST_BOARD_LISTING_MOVES = True
TEST_BOARD_MOVING = True
TEST_PAWNS_KILLING_THE_ENEMY = True
TEST_ROOKS_KILLING_THE_ENEMY = True
TEST_KNIGHTS_KILLING_THE_ENEMY = True
TEST_BISHOPS_KILLING_THE_ENEMY = True
TEST_KINGS_KILLING_THE_ENEMY = True
TEST_QUEENS_KILLING_THE_ENEMY = True
TEST_PAWNS_NOT_KILLING_ALLIES = True
TEST_ROOKS_NOT_KILLING_ALLIES = True
TEST_KNIGHTS_NOT_KILLING_ALLIES = True
TEST_BISHOPS_NOT_KILLING_ALLIES = True
TEST_KINGS_NOT_KILLING_ALLIES = True
TEST_QUEENS_NOT_KILLING_ALLIES = True
TEST_GAME_END = True
